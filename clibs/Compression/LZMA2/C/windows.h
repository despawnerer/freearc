...
#ifdef UNICODE
/*
 * P7ZIP_TEXT is a private macro whose specific use is to force the expansion of
 * a macro passed as an argument to the macro TEXT.  DO NOT use this macro
 * within your programs.  It's name and function could change without notice.
 */
