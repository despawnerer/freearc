...
int main(int argc, char *argv[]) {
  ...
  if (argc == 2) {
    ...
    int result = strcasecmp(argv[1], "d")
                     ? CompressWithHeader(argv[1], callback, NULL)
    ...
    printf("Compressor v2.2 (2012-01-15) - demonstration of FreeArc Unified "
           "Compression Library\n"
           "\n"
           "Usage, compression: Compressor method <infile >outfile\n"
           "       decompression: Compressor d <infile >outfile\n"
           "\n"
           "Note: all FreeArc compression methods are supported, for example "
           "rep:512m+4x4:lzma:ht4:8m\n");
