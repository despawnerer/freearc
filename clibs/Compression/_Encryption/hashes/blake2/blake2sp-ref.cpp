...
static inline int blake2sp_init_leaf(blake2s_state *S, uint8_t outlen,
                                     uint8_t keylen, uint64_t offset) {
  blake2s_param P[1];
...
static inline int blake2sp_init_root(blake2s_state *S, uint8_t outlen,
                                     uint8_t keylen) {
  blake2s_param P[1];
  P->digest_length = outlen;
  P->key_length = keylen;
...
int blake2sp(uint8_t *out, const void *in, const void *key, uint8_t outlen,
