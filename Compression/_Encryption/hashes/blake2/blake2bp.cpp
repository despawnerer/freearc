...
static inline int blake2bp_init_leaf(blake2b_state *S, uint8_t outlen,
...
static inline int blake2bp_init_root(blake2b_state *S, uint8_t outlen,
                                     uint8_t keylen) {
  blake2b_param P[1];
  P->digest_length = outlen;
  P->key_length = keylen;
...
int blake2bp(uint8_t *out, const void *in, const void *key, uint8_t outlen,
